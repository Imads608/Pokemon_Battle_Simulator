import src.Core.API.Common.Ability_Executor.Ability_Effects as ability
#import Battle_API.Common.Ability_Executor.Ability_Effects as ability

class AbilitiesManager(object):
    def __init__(self, typeBattle, battleProperties, pokemonDataSource):
        self.abilitiesMapping = {}
        '''
        {"DOWNLOAD": ability.Download("DOWNLOAD", typeBattle, battleProperties, pokemonDataSource),
