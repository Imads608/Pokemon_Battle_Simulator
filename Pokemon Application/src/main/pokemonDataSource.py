...
class PokemonDataSource(object):
    def __init__(self):
        self.abilitiesMetadata = createMetadata.allAbilities(pkg_resources.resource_filename("resources", "abilities.csv"))
        self.moveFlags = createMetadata.getMoveFlags()
        self.movesMetadata = createMetadata.allMoves(pkg_resources.resource_filename("resources", "moves.csv"))
        self.targetFlags = createMetadata.getTargetFlags()
        self.pokemonImageMetadata = createMetadata.getPokemonImages(pkg_resources.resource_filename("resources", "img/*"))
        self.typesMetadata = createMetadata.getAllTypes(pkg_resources.resource_filename("resources", "types.csv"))
        self.pokedex = createMetadata.getPokedex(pkg_resources.resource_filename("resources", "pokemon.txt"), self.typesMetadata, self.pokemonImageMetadata)
        self.itemsMetadata = createMetadata.allItems(pkg_resources.resource_filename("resources", "items.csv"))
        ...
        self.functionCodesMap = createMetadata.getFunctionCodes(pkg_resources.resource_filename("resources", "Function Codes/Outputs/FCDescription.xlsx"))
        self.abilitiesEffectsMap = createMetadata.getAbilitiesMapping(pkg_resources.resource_filename("resources", "abilityTypes2.csv"))
