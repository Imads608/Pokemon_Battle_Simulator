...
class SinglesBattle(BattleInterface):
    ...
    def startBattle(self):
        ...
        self.getAbilitiesManager().determineAbilityEffects("entry", self.getPlayerBattler(1), self.getPlayerBattler(2), self.getPlayerBattler(1).getPokemonTeam()[self.getPlayerBattler(1).getCurrentPokemon()].getInternalAbility())
        self.getAbilitiesManager().determineAbilityEffects("entry", self.getPlayerBattler(2), self.getPlayerBattler(1), self.getPlayerBattler(2).getPokemonTeam()[self.getPlayerBattler(2).getCurrentPokemon()].getInternalAbility())
